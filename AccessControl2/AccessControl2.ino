...
void setup() {
  ...
  digitalWrite(relayo, HIGH);    // Make sure door is open
  digitalWrite(relayf, HIGH);    // Make sure door is locked
  
  digitalWrite(pir, HIGH);    // Make sure door is locked
...
void normalModeOn () {
  digitalWrite(redLed, LED_ON);  // Make sure Red LED is off
  digitalWrite(greenLed, LED_OFF);  // Make sure Green LED is off
  digitalWrite(relayo, HIGH);    // Make sure Door is Locked
}
